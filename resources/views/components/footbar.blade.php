    ...
    <div class="row container-fluid mt-5">
        ...
        <div class="col-md-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 ">
                        <img src="{{ asset('assets/images/logo.jpeg') }}" alt="logo traveller" class="img" height="100" />
                    </div>
        ...
        <div class="col-md-3 mb-3">
          ...
          <div class="d-flex flex-column gap-3">
            ...
            <a href="https://api.whatsapp.com/send/?phone=628187365833&text&type=phone_number&app_absent=0" target="blank" class="text-dark text-decoration-none text-center">
             <i class="fa-solid fa-envelope"></i>
              <span>08187365833</span>
            </a>
            <a href="mailto:traveller919@gmail.com" target="blank" class="text-dark text-decoration-none text-center">
        ...
        <!-- link -->
        <div class="col-md-2 text-center text-dark text-decoration-none d-flex flex-column gap-1 mt-5 mt-md-0">
        ...
        <!-- follow kami -->
        <div class="col-md-2 mb-5 mt-5 mt-md-0 text-center">
