...
@section('content')
    <div class="container">
      <div class="container d-flex justify-content-center col-12 position-relative  pb-5 border border-2 border-top-0 border-bottom-0">
        <img src="{{ asset('assets/images/profil.jpg') }}" class="position-absolute rounded-circle" width="200" height="200" style="top: -200px" alt="profil">
